...
const ArchivedNotes = () => {
  ...
  const [counter, setCounter] = useState(0); //variable to render the page after something happends, example creating,deleting etc
  ...
  return (
    <div>
      <nav className={styles.navbar}>
        ...
        <Link className={styles.navbar__archivedLink} to={"/"}>Go back to unarchived notes</Link>
      </nav>
      <main>
